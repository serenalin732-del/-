...
create table public.cards (
  ...
  reminder_days_before smallint check (reminder_days_before is null or reminder_days_before between 0 and 60),
  reminder_channel text not null default 'inherit' check (reminder_channel in ('inherit', 'calendar', 'email', 'both')),
  reminder_email text,
...
create table public.automation_settings (
  ...
  reminder_channel text not null default 'both' check (reminder_channel in ('calendar', 'email', 'both')),
  ...
  benefit_reminder_days_2 smallint check (benefit_reminder_days_2 is null or benefit_reminder_days_2 between 0 and 120),
